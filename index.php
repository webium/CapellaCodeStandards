...
<div id="main" role="document">
	<div id="content">
		...
		<!-- GENERAL SECTION -->
		<?php include('elements/general.php'); ?>

		<!-- MARKUP SECTION -->
		<?php include('elements/markup.php'); ?>
		...
		<!-- ACCESSIBILITY SECTION -->
		<?php include('elements/performance.php'); ?>

		<!-- BROWSERS SECTION -->
		<?php include('elements/browsers.php'); ?>

		<!-- SEO SECTION -->
		<?php include('elements/seo.php'); ?>

		<!-- CODE REVIEWS SECTION -->
		<?php include('elements/reviews.php'); ?>

		<!-- APPENDICES/RESOURCES SECTION -->
		<?php include('elements/appendices.php'); ?>
