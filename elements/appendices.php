...
<article id="apendixValidators">
    <h2>Appendix A: Validators</h2>

    <ul>
        <li><i class="icon-minus"></i><a href="http://jigsaw.w3.org/css-validator/">W3C CSS Validation Service</a></li>
        <li><i class="icon-minus"></i><a href="https://addons.mozilla.org/en-US/firefox/addon/249">HTML Validation firefox extension</a></li>
        <li><i class="icon-minus"></i><a href="http://jigsaw.w3.org/css-validator/">CSS validator</a></li>
        <li><i class="icon-minus"></i>Accessibility - <a href="http://wave.webaim.com/">Wave Validation Tool</a></li>
    </ul>
</article>

<article id="apendixTools">
    <h2>Appendix B: Tools</h2>
    
    <ul>
        <li><i class="icon-minus"></i><a href="http://browsershots.org/">Browsershots</a> makes screenshots of your web design in different operating systems and browsers</li>
        <li><i class="icon-minus"></i><a href="https://browserling.com/">Browserling</a> is an interactive cross-browser testing site. Fully interactive sessions, not static screenshots.</li>
        <li><i class="icon-minus"></i>Accessibility - <a href="http://www.w3.org/WAI/ER/existingtools.html">Evaluation, Repair, and Transformation Tools for Web Content Accessibility</a> - lists validation tools for validating, testing and fixing web content to make it more accessible.</li>
    </ul>
</article>    
...
<a href="http://www.sublimetext.com/">Sublime Text</a>. [Linux, Mac, Windows]
        </dd>
...
<a href="http://code.google.com/chrome/devtools/docs/overview.html">Developer Tools</a>.</dd>
...
<p><a href="http://mschrag.github.com/">Speedlimit</a> is a Leopard (works in snow leopard) preference pane for limiting your network bandwidth to one of a couple different speeds—768k DSL, Edge, 3G, and Dialup. Good for testing your lowest supported speeds or when you want to know how your app will function in  real world speeds.</p>
    ...
    <ul>
        <li><i class="icon-minus"></i><a href="http://lesliefranke.com/files/reference/csscheatsheet.html">CSS Cheatsheet</a></li>
        <li><i class="icon-minus"></i><a href="http://www.dezwozhere.com/links.html">CSS Links</a></li>
        <li><i class="icon-minus"></i><a href="http://www.cleancss.com/">Clean CSS</a></li>
        <li><i class="icon-minus"></i><a href="http://csswizardry.com/fluid-grids/">Fluid Grids Code Generator</a></li>
    </ul>

    <h3>Icons</h3>

    <ul> 
        <li><i class="icon-minus"></i><a href="http://http://fontello.com/">Icon Font Builder</a></li>
        <li><i class="icon-minus"></i><a href="http://www.famfamfam.com/lab/icons/silk/">Famfamfam silk icons</a></li>
        <li><i class="icon-minus"></i><a href="http://sublink.ca/icons/">Sweetie</a></li>
        <li><i class="icon-minus"></i><a href="http://delicious.com/paul.irish/icons">Paul Irish's bookmarks for more icons</a></li>
        <li><i class="icon-minus"></i><a href="http://p.yusukekamiyamane.com/">Fugue Icons - 3,100 icons in PNG format.</a></li>
    </ul>

<article id="apendixResources">
    <h2>Appendix C: Resources</h2>

    <ul>
        <li><i class="icon-minus"></i><a href="http://www.ecma-international.org/publications/files/ECMA-ST/ECMA-262.pdf">ECMA 262 5th Edition December 2009</a></li>
        <li><i class="icon-minus"></i><a href="http://dev.opera.com/articles/view/1-introduction-to-the-web-standards-cur/#toc">Opera's The Web Standards Curriculum</a> - basic articles about building with web standards.</li>
        <li><i class="icon-minus"></i><a href="http://nettuts.com/html-css-techniques/10-principles-of-the-css-masters/">10 Principles of the CSS Masters</a> - all of this is smart advice.</li>
        <li><i class="icon-minus"></i><a href="http://www.google.com">Google</a> - when in doubt, google it.</li>
        <li><i class="icon-minus"></i><a href="http://lmgtfy.com/?q=front-end+development+coding+standards&l=1">Too lazy?</a> - let me google that for you then...</li>
        <li><i class="icon-minus"></i><a href="http://developer.yahoo.com/performance/">Yahoo's Exceptional Performance </a>team has maintained one of the best summaries of performance advice.</li>
        <li><i class="icon-minus"></i><a href="http://code.google.com/speed/page-speed/docs/rules_intro.html">Google now has a Speed site</a> with excellent detail. (Click All best practices).</li>
        <li><i class="icon-minus"></i>There are many more excellent resources on <a href="http://delicious.com/paul.irish/optimization">page optimization</a> and <a href="http://delicious.com/paul.irish/performance">javascript performance</a>.</li>
        <li><i class="icon-minus"></i><a href="http://wiki.mozilla.org/WebDev:FrontendCodeStandards">Mozilla's coding standards</a>.</li>
        <li><i class="icon-minus"></i><a href="http://wiki.forum.nokia.com/index.php/JavaScript_Performance_Best_Practices">Nokia's JavaScript Performance Best Practices</a>.</li>
    </ul>
</article>
